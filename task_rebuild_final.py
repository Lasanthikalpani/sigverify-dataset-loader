"""
Task: Rebuild Model with Compatible Lambda Layer
...
print("=" * 70)
print("🧠 SIGVERIFY - REBUILD MODEL (COMPATIBLE)")
print("=" * 70)
...
kaggle_loaded = 0
MAX_PEOPLE = 300  # Reduced for speed
...
# ============================================================
# Build model with COMPATIBLE Lambda
# ============================================================
print("\n🧠 Building compatible model...")
...
def create_model():
    ...
    # FIX: Use K.abs() which doesn't need tf
    dist = layers.Lambda(
...
print("\n✅ Model saved as 'models/model_final.keras'")
print("\n🎉 DONE!")