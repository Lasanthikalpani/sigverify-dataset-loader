"""
Task: Final Training - CEDAR + Kaggle (Reliable Data)
...
print("=" * 70)
print("🧠 SIGVERIFY - FINAL RELIABLE TRAINING")
print("=" * 70)

# ============================================================
# Load CEDAR (10 people) - RELIABLE
# ============================================================
print("\n📂 Loading CEDAR...")
...
# ============================================================
# Load Kaggle (only folders with BOTH genuine + forged)
# ============================================================
print("\n📂 Loading Kaggle (people with both folders)...")
...
for person_dir in genuine_folders:
    ...
    if kaggle_loaded >= 200:  # Limit to 200 people
        break
