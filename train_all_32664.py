"""
Train with ALL 32,664 Kaggle Images
...
print("=" * 70)
print("🧠 SIGVERIFY - TRAIN WITH ALL 32,664 IMAGES")
print("=" * 70)
...
# ============================================================
# Load ALL people from Kaggle (no limit)
# ============================================================
print("\n📂 Loading ALL Kaggle people...")

kaggle_dir = Path('data/raw/kaggle')

# Find genuine folders (no _forg)
genuine_folders = sorted([d for d in kaggle_dir.iterdir()
                          if d.is_dir() and not d.name.endswith('_forg')])

print(f"   Total genuine folders: {len(genuine_folders)}")
...
callbacks = [
    ModelCheckpoint('models/model_all_data.keras',
...
model.save('models/model_all_data.keras')
print(f"\n✅ Model saved as 'models/model_all_data.keras'")
