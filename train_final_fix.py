...
print("=" * 70)
print("🧠 SIGVERIFY - FINAL FIX TRAINING")
print("=" * 70)
...
callbacks = [
    ModelCheckpoint('models/model_fix.keras',
...
model.save('models/model_fix.keras')
print(f"\n✅ Model saved!")
