...
for pid in sorted(people.keys()):
    ...
    g_status = "PASS" if pred1 > threshold else "FAIL"
    f_status = "PASS" if pred2 < threshold else "FAIL"
...
print("=" * 70)
print(f"Genuine tests: {correct_genuine}/10 correct")
print(f"Forged tests:  {correct_forged}/10 correct")
print(f"Overall Accuracy: {(correct_genuine + correct_forged)/20*100:.1f}%")
print("DONE!")