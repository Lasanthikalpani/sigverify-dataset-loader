"""
Task: Train with MORE People from Kaggle
...
print("=" * 70)
print("🧠 SIGVERIFY - TRAIN WITH MORE PEOPLE")
print("=" * 70)

# ============================================================
# Load Kaggle dataset - relaxed criteria
# ============================================================
...
# Use ALL people, relaxed criteria
MAX_PER_PERSON = 5  # Use 5 genuine + 5 forged per person
people = {}
...
for person_dir in genuine_folders:
    ...
    # RELAXED: only need 1 genuine and 1 forged
...
plt.savefig('results/training_kaggle_more.png')
plt.show()
