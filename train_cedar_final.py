"""
CEDAR Training - ORIGINAL Data (What Works)
...
print("=" * 70)
print("🧠 SIGVERIFY - CEDAR ORIGINAL TRAINING")
print("=" * 70)
...
# ============================================================
# Load CEDAR ORIGINAL (data/raw/cedar/)
# ============================================================
print("\n📂 Loading CEDAR ORIGINAL (data/raw/cedar/)...")
...
# ============================================================
# Create pairs (correct person-aware logic)
# ============================================================
print("\n🔀 Creating pairs...")
...
callbacks = [
    ModelCheckpoint('models/model_cedar_original.keras',
...
model.save('models/model_cedar_original.keras')
print(f"\n✅ Model saved!")
...
print(f"   Overall: {(correct_g + correct_f)/total*100:.1f}%")
print("\n🎉 DONE!")