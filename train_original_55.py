"""
CEDAR 55 People - ORIGINAL Only (No Augmentation for Training)
...
# ============================================================
# Create pairs from ORIGINAL images only
# ============================================================
...
print(f"   Training: {len(X1_train)} pairs")
...
callbacks = [
    ModelCheckpoint('models/model_original55.keras',
...
model.save('models/model_original55.keras')
print(f"\n✅ Model saved!")
