"""
Kaggle Training - FIXED Pair Creation
...
print("=" * 70)
print("🧠 SIGVERIFY - KAGGLE FIXED TRAINING")
print("=" * 70)
...
# ============================================================
# Create pairs - DIFFERENT APPROACH
# ============================================================
print("\n🔀 Creating pairs...")
...
# Positive: Same person genuine (ALL combinations)
...
neg1 = len([l for l in y if l == 0])
print(f"   Negative (genuine vs forged): {neg1}")

# Negative 2: Genuine from different person
...
callbacks = [
    ModelCheckpoint('models/model_kaggle_final.keras',
...
model.save('models/model_kaggle_final.keras')
print(f"\n✅ Model saved as 'models/model_kaggle_final.keras'")
...
for pid in person_ids[:100]:  # Test on 100 people
