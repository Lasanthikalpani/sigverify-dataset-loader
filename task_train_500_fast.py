"""
Task: FAST Training with 500 People
...
print("=" * 70)
print("🧠 SIGVERIFY - FAST TRAINING (500 PEOPLE)")
print("=" * 70)
...
# Positive: 1 pair per person (LIMITED)
...
# Negative: genuine vs forged (1 per person)
for pid in person_ids:
    gen = people[pid]['genuine']
...
neg_needed = pos_count - len([l for l in y if l == 0])
...
history = model.fit(
    [X1, X2], y,
    epochs=20,
    batch_size=128,  # Much larger batch for speed
